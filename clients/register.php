			...
			<div class="col-12">
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
							...
							<div id="trave">
		<p class="mb-0">Nhập đầy đủ thông tin và nhấn đăng ký</p></div>							
							</div>
							<div class="p-40">
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Bạn đã có tài khoản?<a href="/clients/login.html" class="text-danger ms-5"> Đăng nhập ngay</a></p>
								</div>
							</div>
						</div>		
						<div class="text-center">
         ...
         $('#submit').click(function(){
			...
			var email = $('#email').val();
				if ( username == '' || password == '' || repassword == '' || email == '') {
					$("#trave").html('<div class="alert"><span class="closebtn" onclick="spawn()">&times;</span><strong>Lỗi !</strong> Vui lòng điền đầy đủ thông tin đăng ký .</div>');
					return false;
				}
