					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Like Page Rẻ</li>
							</ol>
						</nav>
					</div>
				</div>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			 <a style="float:right;" href="/history.html?type=4" class="btn btn-primary"><i class="fas fa-history"></i> Lịch sử đơn hàng</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
...
<div class="form-group row">
                          ...
                          <div class="col-sm-9">
<?php                              
$respawn = mysqli_query($ketnoi,"SELECT * FROM `chietkhau` WHERE `madichvu` = 'likepagesale' AND `webdinhdanh` = '$domain'");
...
<p>+ Hệ thống chạy bằng UID fanpage</p>
...
<p>+ Một fanpage chỉ được mua 1 đơn cùng lúc, đơn cũ chưa xong mà mua thêm sẽ lỗi .</p>
</div>
</div>
...
$['post']('respawn/likepagesale.html',{
    idpost:$('#idpost')['val'](),
    server:$('.form-check-input:checked')['val'](),
    amount:$('#amount')['val'](),
    note:$('#note')['val']()},
