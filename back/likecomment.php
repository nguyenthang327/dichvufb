					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Like Comment</li>
							</ol>
						</nav>
					</div>
				</div>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			 <a style="float:right;" href="/history.html?type=6" class="btn btn-primary"><i class="fas fa-history"></i> Lịch sử đơn hàng</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
...
<div class="form-group row">
                          <label for="idpost" class="col-sm-3 col-form-label">ID comment</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="idpost"  name="idpost" placeholder="Nhập ID comment cần tăng">
                          </div>
                        </div>
                        <br>
<div class="form-group row">
                          ...
                          <div class="col-sm-9">
<?php                              
$respawn = mysqli_query($ketnoi,"SELECT * FROM `chietkhau` WHERE `madichvu` = 'likecomment' AND `webdinhdanh` = '$domain'");
...
<?php else: while ($row = mysqli_fetch_array($respawn, MYSQLI_ASSOC)):?>
  ...
  <?=$row['note']?> <div class="badge bg-primary"><?=$row[$order]?> Coin / 1 Like</div>
  </label>
</div>
     <?php endwhile; endif; ?>                                                 
                    </div>
                    ...
                    <br>
                        ...
                        <br>
                         <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Chọn cảm xúc</label>
                          <div class="col-sm-9">
                    <div class="btn  btn-rounded btn-fw"> 
                    <input class="with-gap" type="radio" name="reaction" id="like" value="like">
                    <label for="like"><img src="/assets/images/reactions/like.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="love" value="love">
                    <label for="love"><img src="/assets/images/reactions/love.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="wow" value="wow">
                    <label for="wow"><img src="/assets/images/reactions/wow.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="haha" value="haha">
                    <label for="haha"><img src="/assets/images/reactions/haha.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="sad" value="sad">
                    <label for="sad"><img src="/assets/images/reactions/sad.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="angry" value="angry">
                    <label for="angry"><img src="/assets/images/reactions/angry.png" width="40px"></label>
                    </div>
                    <div class="btn  btn-rounded btn-fw">
                        <input class="with-gap" type="radio" name="reaction" id="care" value="care">
                    <label for="care"><img src="/assets/images/reactions/thuong_thuong.png" width="40px"></label>
                    </div>
                        </div>
                          </div>
                        <br>  
...
<p>+ Hệ thống chạy bằng UID comment</p>
...
<p>+ Like nhảy sau khoảng c sau khi mua</p>
...
<p>+ Một vài bài share có thể sẽ lỗi không lên like, mọi người có thể qua mua like chậm nhé</p>
<p>+ Một comment chỉ được mua 1 đơn cùng lúc, đơn cũ chưa xong mà mua thêm sẽ lỗi .</p>
</div>
</div>
...
<script type="text/javascript">
function submit(){if(!$('#idpost')['val']()){swal('ERROR','Bạn chưa nhập UID cần tăng Like','error')}
else {if(!$('.form-check-input:checked')['val']()){swal('ERROR','Bạn chưa chọn Server Buff','error')}
else {if(!$('.with-gap:checked')['val']()){swal('ERROR','Vui lòng chọn biểu tượng cảm xúc','error')}
...
$['post']('respawn/likecomment.html',{
    idpost:$('#idpost')['val'](),
    reaction:$('.with-gap:checked')['val'](),
    server:$('.form-check-input:checked')['val'](),
    amount:$('#amount')['val'](),
    note:$('#note')['val']()},
