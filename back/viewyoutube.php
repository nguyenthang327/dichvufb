					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Sub Youtube</li>
							</ol>
						</nav>
					</div>
				</div>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			 <a style="float:right;" href="/history.html?type=24" class="btn btn-primary"><i class="fas fa-history"></i> Lịch sử đơn hàng</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
...
<div class="form-group row">
                          <label for="idpost" class="col-sm-3 col-form-label">Link Video</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="idpost"  name="idpost" placeholder="Nhập Link Video cần tăng">
                          </div>
                        </div>
                        <br>
<div class="form-group row">
                          ...
                          <div class="col-sm-9">
<?php                              
$respawn = mysqli_query($ketnoi,"SELECT * FROM `chietkhau` WHERE `madichvu` = 'viewyoutube' AND `webdinhdanh` = '$domain'");
...
<p>+ Hệ thống chạy bằng Link Video</p>
<p>+ Nhập sai định dạng Link, không bật like cho tất cả sẽ không được hoàn tiền</p>
...
<!-- ./wrapper -->
	...
	<div class="sticky-toolbar">	    
	    ...
	    <a id="chat-popup" href="#" data-bs-toggle="tooltip" data-bs-placement="left" title="Video Hỗ Trợ" class="waves-effect waves-light btn btn-warning btn-flat btn-sm">
