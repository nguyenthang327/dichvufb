					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0">Xin mời nhập đầy đủ thông tin đăng nhập.</p>							
							</div>
							<div class="p-40">
									  ...
									  <div class="row">
										...
										<div class="col-6">
										 <div class="fog-pwd text-end">
											<a href="/forgot.html" class="hover-warning"><i class="ion ion-locked"></i> Bạn quên mật khẩu?</a><br>
										  </div>
										</div>
										<!-- /.col -->
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Bạn chưa có tài khoản? <a href="/register.html" class="text-warning ms-5">Đăng ký ngay</a></p>
								</div>	
							</div>						
						</div>
						<div class="text-center">
  ...
  $('#submit').click(function(){
			...
			var password = $('#password').val();
				if (  username == '' || password == '') {
					swal("ERROR","Vui lòng nhập đầy đủ thông tin đăng nhập !","error");
					return false;
				}
