					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Comment Tiktok</li>
							</ol>
						</nav>
					</div>
				</div>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			 <a style="float:right;" href="/history.html?type=28" class="btn btn-primary"><i class="fas fa-history"></i> Lịch sử đơn hàng</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
...
<div class="form-group row">
                          ...
                          <div class="col-sm-9">
<?php                              
$respawn = mysqli_query($ketnoi,"SELECT * FROM `chietkhau` WHERE `madichvu` = 'commenttiktok' AND `webdinhdanh` = '$domain'");
     ...
     <?php endwhile; endif; ?>                                                 
                    ...
                    <br>
                        <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                        <textarea class="form-control" id="comment" name="comment" rows="3" placeholder="Nhập nội dung bình luận, mỗi nội dung 1 dòng" onchange="checkpoint()"></textarea>
                                    </div> </div><br>
                        <div class="form-group row">
...
<p>+ Hệ thống chạy bằng UID video</p>
...
<p>+ Một video chỉ được mua 1 đơn cùng lúc, đơn cũ chưa xong mà mua thêm sẽ lỗi .</p>
</div>
</div>
...
else {if(!$('#comment')['val']()){swal('ERROR','Bạn chưa nhập nội dung comment','error')}
...
$['post']('respawn/commenttiktok.html',{
    idpost:$('#idpost')['val'](),
    server:$('.form-check-input:checked')['val'](),
    comment:$('#comment')['val'](),
    note:$('#note')['val']()},
