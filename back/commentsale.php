					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Comment Rẻ</li>
							</ol>
						</nav>
					</div>
				</div>
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			 <a style="float:right;" href="/history.html?type=11" class="btn btn-primary"><i class="fas fa-history"></i> Lịch sử đơn hàng</a>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
			  <div class="row">
...
<div class="form-group row">
                          <label for="idpost" class="col-sm-3 col-form-label">Link bài viết</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="idpost"  name="idpost" placeholder="Nhập Link bài viết cần tăng">
                          </div>
                        </div>
                        <br>
<div class="form-group row">
                          ...
                          <div class="col-sm-9">
<?php                              
$respawn = mysqli_query($ketnoi,"SELECT * FROM `chietkhau` WHERE `madichvu` = 'commentsale' AND `webdinhdanh` = '$domain'");
...
<?php else: while ($row = mysqli_fetch_array($respawn, MYSQLI_ASSOC)):?>
  ...
  <?=$row['note']?> <div class="badge bg-primary"><?=$row[$order]?> Coin / 1 Comment</div>
     ...
     <?php endwhile; endif; ?>                                                 
                    ...
                    <br>
                   <div class="form-group row">
                                        <label for="comment" class="col-sm-3 col-form-label">Bình luận</label>
                                        <div class="col-sm-9">
                                        <textarea class="form-control" id="comment" name="comment" rows="10" placeholder="Nhập nội dung bình luận, mỗi nội dung 1 dòng tối thiểu 20 dòng"></textarea>
                                    </div> </div><br> 
                        <div class="form-group row">
...
<p>+ Hệ thống chạy bằng Link bài viết</p>
<p>+ Nhập sai định dạng Link, không bật Comment cho tất cả sẽ không được hoàn tiền</p>
...
<script type="text/javascript">
function submit(){if(!$('#idpost')['val']()){swal('ERROR','Bạn chưa nhập Link cần tăng Comment','error')}
...
else {if(!$('#comment')['val']()){swal('ERROR','Bạn chưa nhập Comment','error')}
