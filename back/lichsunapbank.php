...
$dem2 = mysqli_num_rows(mysqli_query($ketnoi,"SELECT * FROM `historynaptien` WHERE `magd` ='".mysqli_real_escape_string($ketnoi,$seach)."'"));
if($dem1 > 0){
$seachans = "AND `id` = '$seach'";    
}elseif($dem2 > 0){
$seachans = "AND `magd` = '$seach'";    
}else{
$seachans = "";      
}
}else{
					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Lịch Sử Nạp Bank</li>
							</ol>
						</nav>
					</div>
				</div>
...
<li class="nav-item me-3"><a href="#Momo" class="nav-link px-2" data-bs-toggle="tab">Momo</a></li>
<li class="nav-item me-3"><a href="#Mbbank" class="nav-link px-2" data-bs-toggle="tab">MB Bank</a></li>
<li class="nav-item me-3"><a href="#Vietcombank" class="nav-link px-2" data-bs-toggle="tab">Vietcombank</a></li></ul>
...
<th class="border-top-0 pt-0 pb-2">Loại bank</th>
<th class="border-top-0 pt-0 pb-2">Mã giao dịch</th>
<th class="border-top-0 pt-0 pb-2">Số tiền</th>
...
$total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans"));
$total_pages = ceil($total_records / $num_rec_per_page);                                            
$respawn = mysqli_query($ketnoi,"SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans  order by id desc LIMIT $start_from, $num_rec_per_page ");
if (mysqli_num_rows($respawn) == 0):
?>    

 <tr>
<td>Bạn chưa có giao dịch nào !</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
...
<td class="align-middle"><?=$row['magd']?></td>
...
<div class="tab-pane fade show" id="Momo">
<form method="GET" action="">
<div class="input-group">
										<input type="text" class="form-control" placeholder="seach" name="seach" id="seach" required="" aria-invalid="false"> 
										<button type="submit" class="btn btn-info btn-sm" type="button">Tìm kiếm</button> 
...
$num_rec_per_page=100;
$start_from = ($page-1) * $num_rec_per_page;
$total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'Momo' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans"));
$total_pages = ceil($total_records / $num_rec_per_page);                                            
$respawn = mysqli_query($ketnoi,"SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'Momo' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans  order by id desc LIMIT $start_from, $num_rec_per_page ");
if (mysqli_num_rows($respawn) == 0):
?>    
...
<div class="tab-pane fade show" id="Mbbank">
<form method="GET" action="">
<div class="input-group">
										<input type="text" class="form-control" placeholder="seach" name="seach" id="seach" required="" aria-invalid="false"> 
										<button type="submit" class="btn btn-info btn-sm" type="button">Tìm kiếm</button> 
...
$num_rec_per_page=100;
$start_from = ($page-1) * $num_rec_per_page;
$total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'MB Bank' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans"));
$total_pages = ceil($total_records / $num_rec_per_page);                                            
$respawn = mysqli_query($ketnoi,"SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'MB Bank' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans  order by id desc LIMIT $start_from, $num_rec_per_page ");
if (mysqli_num_rows($respawn) == 0):
?>    
...
<div class="tab-pane fade show" id="Vietcombank">
<form method="GET" action="">
<div class="input-group">
										<input type="text" class="form-control" placeholder="seach" name="seach" id="seach" required="" aria-invalid="false"> 
										<button type="submit" class="btn btn-info btn-sm" type="button">Tìm kiếm</button> 
...
$num_rec_per_page=100;
$start_from = ($page-1) * $num_rec_per_page;
$total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'Vietcombank' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans"));
$total_pages = ceil($total_records / $num_rec_per_page);                                            
$respawn = mysqli_query($ketnoi,"SELECT * FROM `historynaptien` WHERE `username` = '$username' AND `type` = 'Vietcombank' AND `webdinhdanh` = '$domain' AND `matinhnang` = 'bank' $seachans  order by id desc LIMIT $start_from, $num_rec_per_page ");
if (mysqli_num_rows($respawn) == 0):
?>    
