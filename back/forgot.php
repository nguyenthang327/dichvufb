						...
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Bạn đã có mật khẩu?<a href="/login.html" class="text-danger ms-5"> Đăng nhập ngay</a></p>
									<p class="mt-15 mb-0">Chưa có tài khoản?<a href="/register.html" class="text-danger ms-5"> Đăng ký ngay</a></p>
								</div>
							</div>
						</div>								
...
<script type="text/javascript">
         $('#submit').click(function(){
			...
			var email = $('#email').val();
				if ( username == '' || email == '') {
					swal("ERROR","Vui lòng điền đầy đủ thông tin khôi phục !","error");
					return false;
				}
