					...
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item" aria-current="page">Lịch sử mua clone</li>
							</ol>
						</nav>
					</div>
				</div>
...
<a href="/clound/history-clone.html" class="btn btn-danger">Reset</a>
</div>
</div>
</div>
</form>    
...
$total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historybuyclone` WHERE `username` = '$username'  $a $b"));
$total_pages = ceil($total_records / $num_rec_per_page);                                            
$respawn = mysqli_query($ketnoi,"SELECT * FROM `historybuyclone` WHERE `username` = '$username'  $a $b  order by id desc LIMIT $start_from, $num_rec_per_page ");
...
<tr>
<td><?=$rowhis['id']?></td>
<td><b class="card-title mb-0"><?=$rowhis['tensanpham']?></b></td>
<td><?=$rowhis['codeoder']?></td>
<td><?=$rowhis['sl']?></td>
<td><?=number_format($rowhis['cash'],'0','.','.')?> VNĐ</td>
<td><?=$rowhis['date']?></td>
<td><a class="badge badge-success" href="/views/<?=$rowhis['codeoder']?>"><font color="white">Xem đơn</font></a> 
