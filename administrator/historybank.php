  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-university"></i> Lịch sử nạp Bank - Ví điện tử</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Lịch sử nạp bằng ngân hàng</h3>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      $total_records = mysqli_num_rows(mysqli_query($ketnoi, "SELECT * FROM `historynaptien`  WHERE `webdinhdanh` = '$domain'  $tanbien"));
                      $total_pages = ceil($total_records / $num_rec_per_page);
                      $respawn = mysqli_query($ketnoi, "SELECT * FROM `historynaptien`  WHERE `webdinhdanh` = '$domain'  $tanbien  order by id desc LIMIT $start_from, $num_rec_per_page ");
                      ...
                      ?>
                        ...
                        <?php else : while ($row = mysqli_fetch_array($respawn, MYSQLI_ASSOC)) : ?>
                          <tr>
                            ...
                            <td><?php echo $row['nguoichuyen'] ?></td>
