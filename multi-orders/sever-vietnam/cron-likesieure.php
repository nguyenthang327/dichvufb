...
$kiemtratinhnang = mysqli_fetch_array(mysqli_query($ketnoi, "SELECT * FROM `danhmuccon` WHERE `webnguon` ='baostar' AND `webdinhdanh` ='$domain' AND `id` = '44'"));
...
if($dem > 0){
// chống đúp đơn
mysqli_query($ketnoi,"UPDATE `danhmuccon` SET `action` = 'off' WHERE `webnguon` ='baostar' AND `webdinhdanh` ='$domain' AND `id` = '44'");
...
mysqli_query($ketnoi,"UPDATE `danhmuccon` SET `action` = 'on' WHERE `webnguon` ='baostar' AND `webdinhdanh` ='$domain' AND `id` = '44'");
